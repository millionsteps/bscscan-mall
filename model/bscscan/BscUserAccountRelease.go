...
type BscUserAccountRelease struct {
	Id           int             `json:"id" gorm:"primarykey;AUTO_INCREMENT"`
	DetailId     int             `json:"detailId" form:"detailId" gorm:"column:detail_id;;type:bigint"`
...
func (BscUserAccountRelease) TableName() string {
	return "tb_bsc_user_account_release"
}
